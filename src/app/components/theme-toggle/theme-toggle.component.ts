...
@Component({
  ...
  imports: [NgClass],
    ...
    <div class="theme-toggle" 
             [ngClass]="{'checked': internalChecked()}"
         (click)="toggle()">
      <div class="toggle-track">
        <div class="toggle-thumb">
          <svg class="toggle-icon" viewBox="0 0 24 24">
                        <path [attr.d]="internalChecked() ? moonPath : sunPath" fill="currentColor"/>
          </svg>
        </div>
      </div>
    </div>
